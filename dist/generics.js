...
const message = returnValue('Qualquer coisa...');
const count = returnValue(5);
function getFirstValueFromArray(array) {
    return array[0];
}
const firsValueFromStringArray = getFirstValueFromArray(["1", "2"]);
const firsValueFromNumberArray = getFirstValueFromArray([10, 20]);
